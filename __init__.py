...
from .testing_operations import DoImg, StMTestImagePrep, StMTestSaveFileToDb, StMTestConnectionOperator, StMTestGetFileFromDbFromUserId, StMTestDeleteFileFromDbFromUserId, ExportToDatabase, StMTestMatchReturn
...
def register():
    ...
    bpy.utils.register_class(StMTestMatchReturn)
...
def unregister():
    ...
    bpy.utils.unregister_class(StMTestMatchReturn)
